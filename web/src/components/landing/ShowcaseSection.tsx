...
export function ShowcaseSection({ onLaunch }: { onLaunch: () => void }) {
  return (
    <section className="mx-auto grid max-w-6xl gap-8 px-6 py-16 md:grid-cols-[1.1fr_1fr] md:px-12">
      <div>
        ...
        <button
          onClick={onLaunch}
          className="mt-6 inline-flex items-center gap-2 rounded-md border border-[#00f0ff]/40 px-4 py-2 text-sm text-[#00f0ff] hover:bg-[#00f0ff]/10 focus-visible:ring-2 focus-visible:ring-blue-500"
        >
