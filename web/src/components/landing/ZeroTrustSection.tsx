...
export function ZeroTrustSection() {
  ...
  return (
    <section ref={ref} className="mx-auto max-w-6xl px-6 py-20 md:px-12">
      <div className="panel flex flex-col items-center border-white/10 bg-white/5 p-8 text-center">
